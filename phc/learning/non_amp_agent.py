...
class NonAMPAgent(common_agent.CommonAgent):
    ...
    def calc_gradients(self, input_dict):
        # Remove discriminator-related inputs
        input_dict.pop("amp_obs", None)
        input_dict.pop("amp_obs_demo", None)
        input_dict.pop("amp_obs_replay", None)
    ...
    def _load_config_params(self, config):
        ...
        self._task_reward_w = 1.0  # Full weight on task reward
        self._disc_reward_w = 0.0  # No discriminator reward

        # Remove AMP-specific configurations
